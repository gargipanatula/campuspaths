...
public class CampusPath {
    ...
    // AF(this) =
    //      x-coordinate of start point => x1
    //      y-coordinate of start point => y1
    //      x-coordinate of end point => x2
    //      y-coordinate of end point => y2
    //      the length of the path => getDistance()
